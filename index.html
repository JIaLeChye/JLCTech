...
<html lang="en">
  ...
  <header>
    <div  class="header">
      ...
      <div class="home">
        <h4 >Life<br>Explore<br>Learn<br>Enjoy!<br></h4> 
      </div>
      <div class="discord"> 
  ...
  <div id="about" class="section">
    <div class="about">
      <h1>About Me</h1>
      <p>Primary Education: <a href="https://www.ppdkk.edu.my/tag/sjkc-st-james/" target="_blank">SJK(C)St James [6E]</a>
        ...
        <br>Tertiary Education(Currently): <a href="https://polikk.mypolycc.edu.my/" target="_blank">Politeknik Kota Kinabalu[Diploma Electronics Engineering (Computer)(DTK3A)]</a>  </p>
    </div>
  </div>
  ...
  <footer class="footer">
    <p>Copyright @ 2021 - 2022(<a href="#contact">The JLC Team</a>)</p>
  </footer>
  </body>
</html>
